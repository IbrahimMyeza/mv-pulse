...
- Production uses Render PostgreSQL and accepts `DATABASE_URL`, `SQLALCHEMY_DATABASE_URI`, other common Render-style database URL env names, or standard `PG*` connection parts; local development can still use `LOCAL_DATABASE_URL`.
