...
class Like(db.Model):
    ...
    __table_args__ = (
        db.CheckConstraint(
            ...
            name="ck_like_has_target",
        ),
        db.UniqueConstraint("user_id", "video_id", name="uq_like_user_video"),
        db.UniqueConstraint("user_id", "reel_id", name="uq_like_user_reel"),
        db.UniqueConstraint("user_id", "voice_reply_id", name="uq_like_user_voice_reply"),
    )
